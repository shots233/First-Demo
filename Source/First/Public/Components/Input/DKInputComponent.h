...
#include "DKInputComponent.generated.h"

UCLASS()
class FIRST_API UDKInputComponent : public UEnhancedInputComponent
{
    GENERATED_BODY()
...
template<class UserObject, typename CallbackFunc>
void UDKInputComponent::BindNativeInputAction(
    const UDataAsset_InputConfig* InputConfig,
    const FGameplayTag& InputTag,
...
template<class UserObject, typename PressedFunc, typename ReleasedFunc>
void UDKInputComponent::BindAbilityInputActions(
    const UDataAsset_InputConfig* InputConfig,
    UserObject* ContextObject,
    PressedFunc InputPressedFunc,
    ReleasedFunc InputReleasedFunc)
